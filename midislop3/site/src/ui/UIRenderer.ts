...
import { drawKnob, drawBipolarKnob, drawFader, drawWavePreview } from './knobDraw';
import { findClearSpot } from './panelLayout';

// drawKnob, drawBipolarKnob, drawFader, drawWavePreview imported from ./knobDraw
// findClearSpot imported from ./panelLayout
